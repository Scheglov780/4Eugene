		...
		function initSlider(container,opt) {
						...
						if (!container.hasClass("revslider-initialised")) {
									...
									********************************/
									...
									try{
										if (opt.hideThumbsUnderResolution!=0 && opt.navigationType=="thumb") {
											if (opt.hideThumbsUnderResolution>jQuery(window).width())
...
********************************/
		...
		********************************/
		...
		var createArrows = function(container,opt) {
						...
						container.parent().find('.tp-rightarrow').on('click',function() {
							if (opt.transition==0) {
						...
						container.parent().find('.tp-leftarrow').on('click',function() {
							if (opt.transition==0) {
									opt.next = opt.next-1;
			...
			setTimeout(function() {
				froogaloop.addEvent('ready', function(data) {
						...
						// PLAY VIDEO IF THUMBNAIL HAS BEEN CLICKED
						 nextcaption.find('.tp-thumb-image').on('click',function() {
													...
													if (html5vid.data('metaloaded')==1 || video.duration!=NaN) {
														...
														if (!html5vid.hasClass("HasListener")) {
																...
																if (jvideo.attr('control') == undefined ) {
																	...
																	html5vid.find('video, .tp-poster, .tp-video-play-button').on('click',function() {
		...
		**************************************************************************/
		...
		var createThumbs = function(container,opt) {
			...
			if (thumbconwidth<max) {
				...
				bullets.parent().on('mouseenter',function() {
