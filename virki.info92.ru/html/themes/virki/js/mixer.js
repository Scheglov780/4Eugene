(function (d) {
    function r(e, c, l, b, a) {
        function f() {
            n.off("webkitTransitionEnd transitionend otransitionend oTransitionEnd");
            c && x(c, l, b, a);
            a.startOrder = [];
            a.newOrder = [];
            a.origSort = [];
        ...
        if (p.length) {
            ...
            setTimeout(function () {
                ...
                u.css(b);
                n.on("webkitTransitionEnd transitionend otransitionend oTransitionEnd", function (a) {
            ...
            setTimeout(function () {
                ...
                if (s.length) {
                    ...
                    u.css(c);
                    n.on("webkitTransitionEnd transitionend otransitionend oTransitionEnd", function (c) {
    ...
    var y = {
        init: function (e) {
            return this.each(function () {
                ...
                d(b.sortSelector).on(b.buttonEvent, function () {
                    if (!b.mixing) {
                        var c =
                                d(this),
                            e = c.attr("data-sort"),
                ...
                d(b.filterSelector).on(b.buttonEvent, function () {
                    if (!b.mixing) {
                        var c = d(this);
