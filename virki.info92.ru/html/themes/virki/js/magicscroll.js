...
var MagicScroll = (function (d) {
	...
	b.mw2 = d.Class({
		...
		target: function (m, i, l, j) {
			...
			m = m % j;
			m < 0 && (m += this.option("loop") != "continue" ? -m: j);
			return m
		},
	...
	b.mw2.Scroll = d.Class(b.mw2, {
		...
		checkOffsets: function (o) {
			...
			if (this.option("loop") == "restart") {
				...
				(o > n()) && (o = (j < n() || o < p()) ? n() : 0);
				(o < 0) && (o = j > 0 ? 0 : n());
				(o == n() || n() == 0) && $mjs(this.core.effect).bindEvent("scroll", this.end);
	...
	var g = d.Class(b, {
				...
				o = (function (u) {
					...
					new c(u[0], {
						onload: (function (B, A) {
							...
							var C, x, z, y = $mjs(A).j19s("display");
		...
		fixItemPosition: function (j) {
			if (this.option("items") > 0) {
				...
				this.h && (i.width /= this.option("items")); ! this.h && (i.height /= this.option("items"));
				(j.item || j).fixPosition("block", i)
			}
		},
		...
		initSize: function () {
			...
			$mjs(this).bindEvent("push", function (i) {
			...
			$mjs(this.effect).bindEvent("effect-complete", (function (u) {
				...
				i = i || (Math.round(Math.random() * 1000) != 0);
				if (!i && (typeof(o) !== "undefined")) {
	...
	d.defined(window.MagicZoomPlus) && (g.extraEffects.MagicZoomPlus = MagicZoomPlus);
	...
	g.stopExtraEffects = function (i) {
		d.$A($mjs(i).byTag("A")).j14(function (j) {
			$mjs(g.extraEffects.classes).j14(function (l) {
				...
				if (("MagicZoom" == l || "MagicZoomPlus" == l) && !(j.zoom && j.zoom.lastUpdate > -1)) {
					return
				}
				g.extraEffects[l].stop(j)
			})
		})
	};
	g.startExtraEffects = function (i) {
		d.$A($mjs(i).byTag("A")).j14(function (j) {
			$mjs(g.extraEffects.classes).j14(function (l) {
				$mjs(j).j13(l) && g.extraEffects[l].start(j)
			})
		})
	};
	if (!d.j21.trident) {
		...
		b.Item.copy = function () {
			g.stopExtraEffects(this);
			var i = this.copy_();
			g.startExtraEffects(this);
			return i
		}
	}
	d.extend(g, {
