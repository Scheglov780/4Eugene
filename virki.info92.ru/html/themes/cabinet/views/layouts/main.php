...
<body class="hold-transition skin-cabinet sidebar-mini">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="/#<? /* =Yii::app()->controller->module->id?>/users/view/id/<?= $userAsManager->uid */ ?>"
                    <? /* onclick = "getContent(this,'<?=addslashes(Utils::fullNameWithInitials($userAsManager->fullname))?>',false);return false;" */ ?>
