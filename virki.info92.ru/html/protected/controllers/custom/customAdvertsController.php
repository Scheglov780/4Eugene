...
class customAdvertsController extends CustomFrontController
{
    ...
    {
        $this->pageTitle = Yii::t('main', 'Объявления');
        $this->breadcrumbs = [
          $this->pageTitle,
        ];
        ...
        $criteria->order = "absolute_order DESC NULLS LAST, created DESC";
        $dataProvider = $model->search($criteria, 50);
