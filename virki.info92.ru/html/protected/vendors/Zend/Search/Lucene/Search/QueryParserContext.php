...
class Zend_Search_Lucene_Search_QueryParserContext
{
     ...
     * @var string|null
     */
    private $_defaultField;  // Signs mode: '+term1 term2 -term3 +(subquery1) -(subquery2)'
    /**
     * Query string encoding
     * @var string
     */
    private $_encoding;  // Boolean operators mode: 'term1 and term2  or  (subquery1) and not (subquery2)'
    /**
     * Query entries
    ...
    public function boost($boostFactor)
    {
        ...
        if ($this->_nextEntryField !== null || $this->_nextEntrySign !== null) {
            require_once 'Zend/Search/Lucene/Search/QueryParserException.php';
            throw new Zend_Search_Lucene_Search_QueryParserException(
              '\'^\' modifier must follow word, phrase or subquery.'
            );
        }
