...
/** @var Imagelib $model */
?>
<div class="modal fade" id="image-lib-update-modal" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><?= Yii::t('main', 'Параметры изображения') ?> #<?php echo $model->id; ?></h4>
      </div>
        <?php
        ...
        $form = $this->beginWidget(
          ...
          [
            'id'                     => 'image-lib-update-form',
            'enableAjaxValidation'   => false,
            'enableClientValidation' => false,
            'method'                 => 'post',
            'action'                 => ["imagelib/update"],
            'type'                   => 'horizontal',
            'htmlOptions'            => [
              'onsubmit' => "return false;",
                /* Disable normal form submit */
                //'onkeypress'=>" if(event.keyCode == 13){ update_imagelib (); } " /* Do ajax call when user presses enter key */
            ],
          ]
        ); ?>
      ...
      <div class="modal-footer">
          ...
          $this->widget(
            ...
            [
              ...
              'htmlOptions' => ['onclick' => 'update_imagelib ();'],
            ]
          );
          ?>
          <?
