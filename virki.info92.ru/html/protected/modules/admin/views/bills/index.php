...
<section class="content">
  <div class="row">
          ...
          [
            ...
            'items' => [
              ...
              [
                ...
                'linkOptions' => ['onclick' => "renderCreateForm_bills_{$typeVal} ()"],
                'visible'     => true,
              ],
              [
    ...
    ?>
    <?
    $this->renderPartial("_ajax_update", ['type' => ($type ? $type : 'all'),]);
    $this->renderPartial("_ajax_create_form", ["model" => $model, 'type' => ($type ? $type : 'all'),]);
    ?>
</section>
<!-- /.content -->
