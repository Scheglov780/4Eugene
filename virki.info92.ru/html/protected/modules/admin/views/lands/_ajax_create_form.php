  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label class="col-sm-3 control-label" for="Lands_tariffs_create">Тарифы</label>
          <div class="col-sm-9">
            <select id="Lands_tariffs_create" class="form-control select2 select2-hidden-accessible"
              ...
              <?= (Yii::app()->user->notInRole(
                ...
                if ($tariffsList && is_array($tariffsList)) {
                    foreach ($tariffsList as $tariff) {
                        ...
                        ?>
                      <option <?/* title="<?= ($land['users'] ? 'Владельцев: ' . $land['users'] : 'Нет владельцев') ?>" */ ?>
                          value="<?= $tariff['tariffs_id'] ?>"><?= $tariff['tariff_short_name'] ?></option>
                    <? }
                } ?>
            </select>
          </div>
