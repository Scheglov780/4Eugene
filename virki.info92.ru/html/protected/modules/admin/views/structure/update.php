...
<section class="content-header">
  <h1>
      <?= Yii::t('main', 'Участок') ?>: <?= $model->land_group .
      '/№' .
      $model->land_number ?>        <?= Utils::getHelp(
        'update',
        true
      ) ?></h1>
</section>
...
<section class="content">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <?php echo $form->textAreaRow($model, 'address', ['id' => 'Lands_address_update_single-' . $model->lands_id]
            ); ?>
            <?
            ...
            echo $form->uneditableRow($model, 'created', ['id' => 'Lands_created_update_single-' . $model->lands_id]
            ); ?>
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label"
                   for="Lands_users_update_single-<?= $model->lands_id ?>">Пользователи</label>
            <div class="col-sm-9">
            ...
            <?php echo $form->checkboxRow($model, 'status', ['id' => 'Lands_status_update_single-' . $model->lands_id]
            ); ?>
        </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Расположение участка</h3>
        </div>
        <div class="box-body">
            <? if (isset($model) && $model->land_geo_longitude) { ?>
              <iframe
                  ...
                  width="100%" height="600" frameborder="0" allowfullscreen="false"></iframe>
            <? } else { ?>
              <p class="text-center">
    ...
    <div class="col-md-12">
      <div class="box box-default collapsed-box">
        ...
        <div class="box-body" style="display: none;">
          <img class="img-responsive pad" src="/images/TZ/002-structura-uchastki.jpg">
        </div>
        <!-- /.box-body -->
      </div>
    </div>
