        ...
        <div class="box-body"> <? /* pre-x-scrollable */ ?>
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a
                    href="#index-finances-structure-<?= ($model->uid ? $model->uid : 'all') ?>"
              ...
              <li><a href="#index-finances-details-<?= ($model->uid ? $model->uid : 'all') ?>"
                     data-toggle="tab"><?= Yii::t(
                        'main',
                        'Детали платежей'
                      ) ?></a></li>
            ...
            <div class="tab-content">
              <div class="active tab-pane"
                   id="index-finances-structure-<?= ($model->uid ? $model->uid : 'all') ?>">
                <!-- ==================  Платежи ==================== -->
                  <?
                  $this->widget(
              ...
              <div class="tab-pane"
                   id="index-finances-details-<?= ($model->uid ? $model->uid : 'all') ?>">
                  <?
                  $this->widget(
                    'booster.widgets.TbGridView',
                    [
