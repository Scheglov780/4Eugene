...
<section class="content-header">
  <h1>
    ...
    <small><?= Yii::t('main', 'от Управляющей Компании, Правления и частные объявления...') ?></small>
          ...
          [
            ...
            'items' => [
              ...
              [
                ...
                'linkOptions' => ['onclick' => 'renderCreateForm_adverts ()'],
                'visible'     => true,
              ],
            ],
          ]
        ...
        <div class="box-body">
            <? $this->widget(
              ...
              [
                ...
                'summaryText'   => Yii::t('main', 'Объявления') . ' {start}-{end} ' . Yii::t(
                    'main',
                    'из'
                  ) . ' {count}',
              ]
...
<script type="text/javascript">
    function delete_record_adverts(id) {
        ...
        jQuery.ajax({
            type: 'POST',
            url: '<?php echo Yii::app()->createAbsoluteUrl(Yii::app()->controller->module->id . '/adverts/delete'); ?>',
            data: data,
    ...
    function advertsConfirm(addlink, id) {
        ...
        $.get(url, null,
            function (data) {
                $('#adverts-confirm-button-' + id).tooltip('hide');
                $('#adverts-confirm-button-' + id).remove();
