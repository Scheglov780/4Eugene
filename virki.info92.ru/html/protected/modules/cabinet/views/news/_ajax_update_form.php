  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <?php echo $form->hiddenField($model, 'news_id', ['id' => 'news_news_id_update']); ?>
        <div class="form-group">
          <div class="col-sm-12">
              <?php echo $form->textArea(
                $model,
                'news_header',
                ['id' => 'news_news_header_update', 'class' => 'form-control']
              ); ?>
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-12">
              <?php echo $form->textArea(
                $model,
                'news_body',
                ['id' => 'news_news_body_update', 'class' => 'form-control']
              ); ?>
          </div>
        </div>
          <?php echo $form->hiddenField($model, 'news_type', ['id' => 'news_news_type_update']); ?>
          <?php
