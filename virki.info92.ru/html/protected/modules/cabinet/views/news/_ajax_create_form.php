        ...
        <div class="form-group">
          <div class="col-sm-12">
              <?php echo $form->textArea(
                $model,
                'news_header',
                ['id' => 'news_news_header_create', 'class' => 'form-control']
              ); ?>
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-12">
              <?php echo $form->textArea(
                $model,
                'news_body',
                ['id' => 'news_news_body_create', 'class' => 'form-control']
              ); ?>
          </div>
        </div>
          <?
...
67	VOTING_TYPE	Опрос
           */
          $model->news_type = 63;
          echo $form->hiddenField($model, 'news_type', ['id' => 'news_news_type_create']);
          ?>
