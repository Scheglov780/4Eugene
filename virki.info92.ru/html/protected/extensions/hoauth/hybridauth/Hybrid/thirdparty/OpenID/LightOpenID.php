...
class LightOpenID
{
    ...
    protected function is_allowed_type($content_type)
    {
        ...
        $allowed_types = ['application/xrds+xml', 'text/html', 'text/xml'];
     ...
     * @param String $select_identifier Whether to request OP to select identity for an user in OpenID 2. Does not
     *                                  affect OpenID 1.
    ...
    function validate()
    {
        ...
        foreach (explode(',', $this->data['openid_signed']) as $item) {
            ...
            $params['openid.' . $item] =
              function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() ? stripslashes($value) : $value;
