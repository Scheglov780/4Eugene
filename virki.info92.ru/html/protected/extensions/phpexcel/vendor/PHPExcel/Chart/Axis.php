...
class PHPExcel_Chart_Axis extends PHPExcel_Chart_Properties
{
    ...
    public function setAxisOptionsProperties(
      ...
      $minor_unit = null
        ...
        ($horizontal_crosses_value !== null) ?
          $this->axisOptions['horizontal_crosses_value'] = (string) $horizontal_crosses_value : null;
    ...
    public function setLineStyleProperties(
      ...
      $end_arrow_size = null
        ...
        (!is_null($line_width)) ?
          $this->lineStyleProperties['width'] = $this->getExcelPointsWidth((float) $line_width) : null;
