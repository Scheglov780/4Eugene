...
class PHPExcel_Writer_Excel2007_StringTable extends PHPExcel_Writer_Excel2007_WriterPart
{
        ...
        if ($pSheet !== null) {
            ...
            foreach ($pSheet->getCellCollection() as $cellID) {
                ...
                if (!is_object($cellValue) &&
                  ...
                  ($cell->getDataType() == PHPExcel_Cell_DataType::TYPE_STRING ||
                    $cell->getDataType() == PHPExcel_Cell_DataType::TYPE_STRING2 ||
                    $cell->getDataType() == PHPExcel_Cell_DataType::TYPE_NULL)) {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function writeRichTextForCharts(
      PHPExcel_Shared_XMLWriter $objWriter = null,
      $pRichText = null,
      $prefix = null
    ) {
