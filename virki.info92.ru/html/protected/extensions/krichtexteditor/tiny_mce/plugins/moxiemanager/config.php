...
// Filesystem
$moxieManagerConfig['filesystem.rootpath'] = $_SERVER["DOCUMENT_ROOT"] . "/images/tiny";  ///webroot/uploads';
...
$moxieManagerConfig['createdoc.templates'] =
  'Index page=/files/templates/document.htm,Normal page=/files/templates/another_document.htm';
