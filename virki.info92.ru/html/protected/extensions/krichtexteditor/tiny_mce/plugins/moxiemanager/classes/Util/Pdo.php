...
/**
 * This class extends the PHP PDO class and adds table prefix support to all queries. It also provides some helper
 * functions.
 * @package MOXMAN_Util
 */
class MOXMAN_Util_Pdo extends PDO
{
     ...
     */
    public function __construct($dsn, $user = null, $password = null, $driverOptions = [], $prefix = null)
    {
