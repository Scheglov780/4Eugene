...
/**
 * Command for altering images. This command lets you modify images using specific ations like resize, fip, rotate and
 * crop. These are used as a fallback when the client browser doesn't have image editing support.
 * @package MOXMAN_Core
 */
