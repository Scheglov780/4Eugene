...
class MOXMAN_Util_EventArgs
{
    ...
    /**
     * Cancels the action to be executed after the event. This is normally used in events called just before an action
     * is to be performed.
     */
    ...
    /**
     * Returns true/false if the event is cancelled or not. This will block the action followed by the event. This is
     * normally used to cancel an action on a event called before the action.
