...
class MOXMAN_Core_ListFilesCommand extends MOXMAN_Core_BaseCommand
{
    ...
    public function execute($params)
    {
        ...
        foreach ($files as $subFile) {
            ...
            $attrs .= $subFile->isFile() && $editFilter->accept($subFile) === MOXMAN_Vfs_CombinedFileFilter::ACCEPTED ?
              "e" : "-";
            $attrs .= $subFile->isFile() && $viewFilter->accept($subFile) === MOXMAN_Vfs_CombinedFileFilter::ACCEPTED ?
              "v" : "-";
