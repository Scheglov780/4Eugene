...
class MOXMAN_Http_Response
{
    ...
    /**
     * Loads the specified file and streams it to http response without setting any headers. This method is used by
     * mockup classes to override the default behavior.
