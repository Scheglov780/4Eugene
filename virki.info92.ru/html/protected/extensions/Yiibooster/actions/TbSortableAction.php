 ...
 * It is a component that works in conjunction of TbExtendedGridView widget with sortableRows true. Just attach to the
 * controller you wish to make the calls to.
    ...
    public function run()
    {
        ...
        if (!$model->hasAttribute($sortableAttribute)) {
            throw new CHttpException(
              ...
              ['{attribute}' => 'sortableAttribute', '{value}' => $sortableAttribute]
            )
            );
        }
