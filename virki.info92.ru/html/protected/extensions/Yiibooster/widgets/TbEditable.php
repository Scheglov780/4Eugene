...
class TbEditable extends CWidget
{
    ...
    public $onShown;
    /**
     * @var array all config options of x-editable. See full list <a
     *      href="http://vitalets.github.com/x-editable/docs.html#editable">here</a>.
     */
    public $options = [];
    /**
    ...
    public $pk = null;
    /**
     * @var string placement of popup. Can be `left`, `top`, `right`, `bottom`. If `null` - default X-editable value is
     *      used: `top`
     * @see x-editable
     */
     ...
     * When 'auto' data will be sent on server only if **pk** and **url** defined, otherwise new value will be stored
     * locally.
     * @see x-editable
     */
    public $send = null;
    ...
    public $success = null;
    /**
     * @var string template for **combodate** input. For details see
     *      http://vitalets.github.com/x-editable/docs.html#combodate.
     * @package combodate
     * @see     x-editable
     */
        ...
        if ($this->_prepareToAutotext) {
            ...
            if ($this->type == 'date' || $this->type == 'datetime') {
                ...
                if ($this->value instanceof DateTime ||
                  is_long($this->value) ||
                  (is_string($this->value) && ctype_digit($this->value))) {
                    /*
    ...
    public function registerAssets()
    {
        ...
        if ($this->type == 'date' || $this->type == 'combodate') {
            ...
            $widget = Yii::app()->widgetFactory->createWidget(
              ...
              ['options' => isset($this->options['datepicker']) ? $this->options['datepicker'] : []]
            );
            ...
            $widget = Yii::app()->widgetFactory->createWidget(
              ...
              ['options' => $this->options['datetimepicker']]
            );
            $widget->registerLanguageScript();
        }
    ...
    public function registerClientScript()
    {
        ...
        if ($this->liveTarget) {
            $script .= "\n $('body').on('ajaxUpdate.editable', function(e){ if(e.target.id == '" .
              $this->liveTarget .
              "') yiiEditable(); });";
            ...
            foreach ($models as $model) {
                ...
                if ($group === null) {
                    ...
                    if (!isset($groups[$group])) {
                        $groups[$group] =
                          ['value' => $group, 'text' => $groupText, 'children' => [], 'index' => count($listData)];
