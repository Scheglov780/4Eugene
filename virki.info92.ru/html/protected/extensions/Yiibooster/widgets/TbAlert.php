...
class TbAlert extends TbWidget
{
     ...
     * It should be an array with elements being a javascript string containing event handler function definition
     * (along with declaration) and indexed with the names of events. This will be fed to jQuery.on verbatim.
     * @volatile
     */
    public $events = [];
    /**
