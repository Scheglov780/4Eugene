        ...
        foreach ($this->buttons as $button) {
            ...
            $this->controller->widget(
              ...
              [
                ...
                'items'           => isset($button['items']) ? $button['items'] : [],
                'ajaxOptions'     => isset($button['ajaxOptions']) ? $button['ajaxOptions'] : [],
                'htmlOptions'     => isset($button['htmlOptions']) ? $button['htmlOptions'] : [],
                'dropdownOptions' => isset($button['dropdownOptions']) ? $button['dropdownOptions'] : [],
                ...
                'tooltipOptions'  => isset($button['tooltipOptions']) ? $button['tooltipOptions'] : [],
              ]
            );
