...
class TbInputVertical extends TbInput
{
    ...
    protected function checkBox()
    {
        ...
        [$hidden, $checkbox] = $this->getSeparatedSelectableInput();
    ...
    protected function checkBoxGroupsList()
    {
        ...
        if (isset($label_for)) {
            $this->labelOptions = ['for' => $label_for];
        }
    ...
    protected function ckEditor()
    {
        ...
        $this->widget(
          ...
          [
            'model'         => $this->model,
            'attribute'     => $this->attribute,
            'editorOptions' => isset($options) ? $options : [],
    ...
    {
        $attribute = $this->attribute;
        [$hidden, $radioButton] = $this->getSeparatedSelectableInput();
