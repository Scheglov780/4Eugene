...
class TbTimePicker extends TbBaseInputWidget
{
     ...
     * You can generate the Javascript files from PHP, too, there's no need in hand-crafted snippets of Javascript
     * polluting view files.
     */
    public $events = [];
    /**
     ...
     * disableFocus    boolean    false    Disables the input from focusing. This is useful for touch screen devices
     * that display a keyboard on input focus. modalBackdrop    boolean    false    Show modal backdrop.
     */
    public $options = [];
    /**
    ...
    private function echoAppend()
    {
        ...
        echo CHtml::tag(
          ...
          CHtml::tag('i', ['class' => 'glyphicon glyphicon-time'], '')
        );
    }
