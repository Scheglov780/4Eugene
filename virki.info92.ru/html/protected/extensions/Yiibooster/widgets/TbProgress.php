...
class TbProgress extends TbWidget
{
    ...
    protected $progressBarClasses = ['progress-bar'];
    protected $progressClasses = ['progress'];
    /**
    ...
    public function run()
    {
        ...
        if (empty($this->stacked)) {
            echo '<div class="' .
              implode(' ', $this->progressBarClasses) .
              '" style="width: ' .
              $this->percent .
              '%;">' .
              $this->content .
            ...
            foreach ($this->stacked as $bar) {
                $options = isset($bar['htmlOptions']) ? $bar['htmlOptions'] : [];
