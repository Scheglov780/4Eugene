...
class TbPager extends CLinkPager
{
     ...
     * @param string  $class    the CSS class for the page button. This could be 'page', 'first', 'last', 'next' or
     *                          'previous'.
    ...
    protected function createPageButton($label, $page, $class, $hidden, $selected)
    {
        ...
        return CHtml::tag('li', ['class' => $class], CHtml::link($label, $this->createPageUrl($page)));
    }
    ...
    public function init()
    {
        ...
        if (!empty($classes)) {
            ...
            if (isset($this->htmlOptions['class'])) {
                if (!preg_match("/\b{$classes}\b/i", $this->htmlOptions['class'])) {
                    $this->htmlOptions['class'] = $this->htmlOptions['class'] . ' ' . $classes;
                }
            } else {
