...
class TbJsonGridView extends TbGridView
{
    ...
    /**
     * @var int $cacheTTL how long we keep the responses on cache? It will depend on cacheTTLType (seconds, minutes,
     *      hours)
     */
    public $cacheTTL = 1;
    /**
     ...
     */
    public $pager = ['class' => 'booster.widgets.TbJsonPager'];
    /**
    ...
    public function registerClientScript()
    {
        ...
        foreach (['beforeAjaxUpdate', 'afterAjaxUpdate', 'ajaxUpdateError', 'selectionChanged'] as $prop) {
            if ($this->{$prop} !== null) {
