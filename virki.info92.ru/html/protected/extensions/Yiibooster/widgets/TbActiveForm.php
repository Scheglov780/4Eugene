...
class TbActiveForm extends CActiveForm
{
    ...
    {
        if (isset($options['widgetOptions']['htmlOptions']['id'])) {
            $options['labelOptions']['for'] = $options['widgetOptions']['htmlOptions']['id'];
        }
    ...
    protected function horizontalGroup(&$fieldData, &$model, &$attribute, &$options)
    {
        ...
        $groupOptions =
          isset($options['groupOptions']) ? $options['groupOptions'] : []; // array('class' => 'form-group');
        self::addCssClass($groupOptions, 'form-group');

        if ($model->hasErrors($attribute)) {
            self::addCssClass($groupOptions, 'has-error');
        } elseif ($model->$attribute === '' || is_null($model->$attribute)) {
            self::addCssClass($groupOptions, 'has-warning');
        } else {
            self::addCssClass($groupOptions, 'has-success');
        }
        ...
        if ($this->showErrors && $options['errorOptions'] !== false) {
            echo $this->error(
              ...
              $options['enableAjaxValidation'],
              $options['enableClientValidation']
            );
        }
...
// Alexy wrappers ===============================
     ...
     * @param array  $widgetOptions List of initial property values for the CCaptcha widget (Property Name => Property
     *                              Value).
     * @param array  $options       Group attributes.
     ...
     */
    public function captchaGroup($model, $attribute, $htmlOptions = [], $options = [])
    {
    ...
    public function captchaRow($model, $attribute, $htmlOptions = [], $options = [])
    {
        return $this->captchaGroup($model, $attribute, $htmlOptions, $options);
    }
    ...
    public function checkboxGroup($model, $attribute, $options = [])
    {
        ...
        if ((!array_key_exists('uncheckValue', $options['widgetOptions']) ||
            isset($options['widgetOptions']['uncheckValue']))
    ...
    public function checkboxListRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
            $intOptions = $options;
        }
        return $this->checkboxListGroup($model, $attribute, $intOptions);
    }

    public function checkboxRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->checkboxGroup($model, $attribute, $intOptions);
    }
     ...
     * @see customFieldGroup
     */
    public function ckEditorGroup($model, $attribute, $options = [])
    {

        return $this->widgetGroupInternal('booster.widgets.TbCKEditor', $model, $attribute, $options);
    }

    public function ckEditorRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->ckEditorGroup($model, $attribute, $intOptions);
    }
     ...
     * @see customFieldGroup
     */
    public function colorPickerGroup($model, $attribute, $options = [])
    {

        return $this->widgetGroupInternal('booster.widgets.TbColorPicker', $model, $attribute, $options);
    }

    public function colorPickerRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->colorPickerGroup($model, $attribute, $intOptions);
    }
    ...
    public function customFieldRow($fieldData, $model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->customFieldGroup($fieldData, $model, $attribute, $intOptions);
    }
    ...
    public function dateFieldRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->dateFieldGroup($model, $attribute, $intOptions);
    }
    ...
    public function datePickerRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->datePickerGroup($model, $attribute, $intOptions);
    }
    ...
    public function dateRangeRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->dateRangeGroup($model, $attribute, $intOptions);
    }
    ...
    public function dateTimePickerRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->dateTimePickerGroup($model, $attribute, $intOptions);
    }
    ...
    public function dropDownListGroup($model, $attribute, $options = [])
    {
        ...
        $fieldData =
          [[$this, 'dropDownList'], [$model, $attribute, $widgetOptions['data'], $widgetOptions['htmlOptions']]];

        return $this->customFieldGroupInternal($fieldData, $model, $attribute, $options);
    }

    public function dropDownListRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->dropDownListGroup($model, $attribute, $intOptions);
    }
    ...
    public function emailFieldRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->emailFieldGroup($model, $attribute, $intOptions);
    }

    /**
     * Displays a summary of validation errors for one or several models.
     * This method is a wrapper for {@link CActiveForm::errorSummary}.
     * @param mixed  $models      The models whose input errors are to be displayed. This can be either a single model
     *                            or an array of models.
    ...
    public function fileFieldRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->fileFieldGroup($model, $attribute, $intOptions);
    }
//===============================================
     ...
     * @see customFieldGroup
     */
    public function html5EditorGroup($model, $attribute, $options = [])
    {
    ...
    public function listBoxRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->listBoxGroup($model, $attribute, $intOptions);
    }
     ...
     * @see customFieldGroup
     */
    public function markdownEditorGroup($model, $attribute, $options = [])
    {

        return $this->widgetGroupInternal('booster.widgets.TbMarkdownEditor', $model, $attribute, $options);
    }

    public function markdownEditorRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->markdownEditorGroup($model, $attribute, $intOptions);
    }
    ...
    public function maskedTextFieldRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->maskedTextFieldGroup($model, $attribute, $intOptions);
    }
    ...
    public function numberFieldRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->numberFieldGroup($model, $attribute, $intOptions);
    }
     ...
     * @see customFieldGroup
     */
    public function passFieldGroup($model, $attribute, $options = [])
    {

        return $this->widgetGroupInternal('booster.widgets.TbPassfield', $model, $attribute, $options);
    }

    public function passFieldRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->passFieldGroup($model, $attribute, $intOptions);
    }
    ...
    public function passwordFieldRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->passwordFieldGroup($model, $attribute, $intOptions);
    }
    ...
    public function radioButtonListRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->radioButtonListGroup($model, $attribute, $intOptions);
    }

    public function radioButtonRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->radioButtonGroup($model, $attribute, $options);
    }
    ...
    public function rangeFieldRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->rangeFieldGroup($model, $attribute, $intOptions);
    }
    ...
    public function redactorRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->redactorGroup($model, $attribute, $intOptions);
    }
     ...
     * @see customFieldGroup
     */
    public function searchFieldGroup($model, $attribute, $options = [])
    {
        ...
        $fieldData = [[$this, 'searchField'], [$model, $attribute, $widgetOptions['htmlOptions']]];

        return $this->customFieldGroupInternal($fieldData, $model, $attribute, $options);
    }

    public function searchFieldRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->searchFieldGroup($model, $attribute, $intOptions);
    }
    ...
    public function switchRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->switchGroup($model, $attribute, $intOptions);
    }
     ...
     * @see customFieldGroup
     */
    public function telFieldGroup($model, $attribute, $options = [])
    {
        ...
        $fieldData = [[$this, 'telField'], [$model, $attribute, $widgetOptions['htmlOptions']]];

        return $this->customFieldGroupInternal($fieldData, $model, $attribute, $options);
    }

    public function telFieldRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->telFieldGroup($model, $attribute, $intOptions);
    }
    ...
    public function textAreaRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->textAreaGroup($model, $attribute, $intOptions);
    }
    ...
    public function textFieldRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->textFieldGroup($model, $attribute, $intOptions);
    }
    ...
    public function timeFieldRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->timeFieldGroup($model, $attribute, $intOptions);
    }
    ...
    public function timePickerRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->timePickerGroup($model, $attribute, $intOptions);
    }
    ...
    public function typeAheadRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->typeAheadGroup($model, $attribute, $intOptions);
    }

    public function uneditableRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
     ...
     * @see customFieldGroup
     */
    public function urlFieldGroup($model, $attribute, $options = [])
    {
        ...
        $fieldData = [[$this, 'urlField'], [$model, $attribute, $widgetOptions['htmlOptions']]];

        return $this->customFieldGroupInternal($fieldData, $model, $attribute, $options);
    }

    public function urlFieldRow($model, $attribute, $options = [])
    {
        if (!isset($options['widgetOptions'])) {
            $intOptions = ['widgetOptions' => ['htmlOptions' => $options]];
        } else {
        ...
        return $this->urlFieldGroup($model, $attribute, $intOptions);
    }
    ...
    public function widgetRow($className, $model, $attribute, $options = [])
    {
        return $this->widgetGroup($className, $model, $attribute, $options);
    }
