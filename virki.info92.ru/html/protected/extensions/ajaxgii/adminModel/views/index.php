...
<div class="row sticky">
    ...
    <?php echo $form->textField($model, 'connectionId', ['size' => 65]) ?>
  <div class="tooltip">
...
<div class="row sticky">
    ...
    <?php echo $form->textField($model, 'tablePrefix', ['size' => 65]); ?>
  <div class="tooltip">
...
<div class="row">
    ...
    <?php $this->widget('zii.widgets.jui.CJuiAutoComplete', [
      ...
      'attribute'   => 'tableName',
      'name'        => 'tableName',
      'source'      => Yii::app()->hasComponent($model->connectionId) ?
        array_keys(Yii::app()->{$model->connectionId}->schema->getTables()) : [],
      'options'     => [
        'minLength' => '0',
        'focus'     => new CJavaScriptExpression(
          'function(event,ui) {
