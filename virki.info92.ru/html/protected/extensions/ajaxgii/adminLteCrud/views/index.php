...
?>
<h1>Bootstrap Generator for Admin panel (ajax)</h1>
...
<div class="row sticky">
  ...
  <div class="tooltip">
    ...
    Please make sure the class exists and can be autoloaded.<br/>
  </div>
  <div>
    Pls use the <strong>CustomAdminController</strong> by default.
  </div>
