...
/**
 * Класс, реализующий работу с DSGDownloaredJsEngine с некоторыми специфическими особенностями.
 */
class DSGDownloaderJs extends DSGDownloaderBase
{
...
//        $execRes->cookies = '';
    ...
    public static function getCurl(
      ...
      $forDSProxy = false
        ...
        $engine = new DSGDownloaderJsEngine();
        $engine->run();
...
// Close the multi-handle and return our results
    ...
    public static function getRedirectUrl($url, $mr = 20)
    {
        /** @noinspection PhpUnusedLocalVariableInspection */
        $header = '';
        //TODO: Maybe it's not needed t oinitialize this
        $_url = '';
        //TODO: Maybe it's not needed t oinitialize this
        $newurl = '';
        $startTime = microtime(true);
