...
class Telerivet_Project extends Telerivet_Entity
{
    ...
    {
        return new Telerivet_Broadcast(
          $this->_api,
          $this->_api->doRequest("GET", "{$this->getBaseApiPath()}/broadcasts/{$id}")
        );
    }
    ...
    {
        return new Telerivet_Contact(
          $this->_api,
          $this->_api->doRequest("GET", "{$this->getBaseApiPath()}/contacts/{$id}")
        );
    }
    ...
    {
        return new Telerivet_DataTable(
          $this->_api,
          $this->_api->doRequest("GET", "{$this->getBaseApiPath()}/tables/{$id}")
        );
    }
    ...
    {
        return new Telerivet_Group(
          $this->_api, $this->_api->doRequest("GET", "{$this->getBaseApiPath()}/groups/{$id}")
        );
    }
    ...
    {
        return new Telerivet_Label(
          $this->_api, $this->_api->doRequest("GET", "{$this->getBaseApiPath()}/labels/{$id}")
        );
    }
    ...
    {
        return new Telerivet_Message(
          $this->_api,
          $this->_api->doRequest("GET", "{$this->getBaseApiPath()}/messages/{$id}")
        );
    }
    ...
    function getOrCreateDataTable($name)
    {
        return new Telerivet_DataTable(
          $this->_api,
          $this->_api->doRequest("POST", "{$this->getBaseApiPath()}/tables", ['name' => $name])
        );
    }
    ...
    function getOrCreateGroup($name)
    {
        return new Telerivet_Group(
          $this->_api,
          $this->_api->doRequest("POST", "{$this->getBaseApiPath()}/groups", ['name' => $name])
        );
    }
    ...
    function getOrCreateLabel($name)
    {
        return new Telerivet_Label(
          $this->_api,
          $this->_api->doRequest("POST", "{$this->getBaseApiPath()}/labels", ['name' => $name])
        );
    }
    ...
    {
        return new Telerivet_Phone(
          $this->_api, $this->_api->doRequest("GET", "{$this->getBaseApiPath()}/phones/{$id}")
        );
    }
    ...
    {
        return new Telerivet_MobileMoneyReceipt(
          $this->_api,
          $this->_api->doRequest("GET", "{$this->getBaseApiPath()}/receipts/{$id}")
        );
    }
    ...
    {
        return new Telerivet_Route(
          $this->_api, $this->_api->doRequest("GET", "{$this->getBaseApiPath()}/routes/{$id}")
        );
    }
    ...
    {
        return new Telerivet_ScheduledMessage(
          $this->_api,
          $this->_api->doRequest("GET", "{$this->getBaseApiPath()}/scheduled/{$id}")
        );
    }
    ...
    {
        return new Telerivet_Service(
          $this->_api,
          $this->_api->doRequest("GET", "{$this->getBaseApiPath()}/services/{$id}")
        );
    }
    ...
    {
        return new Telerivet_MobileMoneyReceipt($this->_api, ['project_id' => $this->id, 'id' => $id], false);
    }
    ...
    {
        return $this->_api->newApiCursor(
          'Telerivet_MobileMoneyReceipt',
          "{$this->getBaseApiPath()}/receipts",
          $options
        );
    }
    ...
    function receiveMessage($options)
    {
        return new Telerivet_Message(
          $this->_api,
          $this->_api->doRequest("POST", "{$this->getBaseApiPath()}/messages/receive", $options)
        );
    }
    ...
    function scheduleMessage($options)
    {
        return new Telerivet_ScheduledMessage(
          $this->_api,
          $this->_api->doRequest('POST', $this->getBaseApiPath() . '/scheduled', $options)
        );
    }
    ...
    function sendMessage($options)
    {
        return new Telerivet_Message(
          $this->_api,
          $this->_api->doRequest('POST', $this->getBaseApiPath() . '/messages/send', $options)
        );
    }
